...
# define PLAYER_LASER_PERFORATION(scenario) (scenario == GAME_SCENARIO_EASY ? 0 : \
								scenario == GAME_SCENARIO_MEDIUM ? 0 : \
								scenario == GAME_SCENARIO_HARD ? 0 : \
								scenario == GAME_SCENARIO_WW3 ? 1 : \
								scenario == GAME_SCENARIO_DOOMSDAY ? 2 : \
								scenario == GAME_SCENARIO_MULTIPLAYER ? 0 : 0)

# define ENEMY_LASER_DAMAGE(scenario) (scenario == GAME_SCENARIO_EASY ? 10 : \
								scenario == GAME_SCENARIO_MEDIUM ? 20 : \
								scenario == GAME_SCENARIO_HARD ? 30 : \
								scenario == GAME_SCENARIO_WW3 ? 50 : \
								scenario == GAME_SCENARIO_DOOMSDAY ? 100 : \
